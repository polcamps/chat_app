...
class _UsuariosPageState extends State<UsuariosPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final _usuario = _authService.usuario!;

    return Scaffold(
      appBar: AppBar(
        title: Text(_usuario.nombre, style: TextStyle(color: Colors.black54)),
        elevation: 1,
    ...
    return ListTile(
      ...
      trailing: Container(
        ...
        decoration: BoxDecoration(
          color: usuario.online != null && usuario.online! ? Colors.green[300] : Colors.red,
